                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg bg-neutral-900/50 border border-white/10 px-4 py-3 text-white placeholder-neutral-500 outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-colors"
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 rounded-lg bg-neutral-900/50 border border-white/10 px-4 py-3 text-white placeholder-neutral-500 outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-colors"
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 disabled:bg-neutral-700 disabled:text-neutral-500 text-white text-sm font-medium transition-colors flex items-center gap-2 min-w-[100px] justify-center"
                                    >
                                        {isVerifying ? (
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-3 rounded-lg bg-green-600 hover:bg-green-500 disabled:bg-neutral-700 disabled:text-neutral-500 text-white text-sm font-medium transition-colors flex items-center gap-2 min-w-[100px] justify-center"
                                            >
                                                {isVerifying ? (
                                                    <Loader2 className="h-4 w-4 animate-spin" />
                                                ) : (
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full rounded-lg bg-neutral-900/50 border border-white/10 px-4 py-3 text-white outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-colors appearance-none cursor-pointer scrollbar-thin scrollbar-track-neutral-800 scrollbar-thumb-neutral-600 hover:scrollbar-thumb-neutral-500"
                                        required
                                    >
